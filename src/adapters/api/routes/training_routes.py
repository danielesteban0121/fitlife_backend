...
from src.adapters.api.dependencies_phase_f import get_create_routine, get_assign_routine, get_complete_workout
from src.application.dtos.training_dtos import (
    CreateRoutineRequestDTO, CreateRoutineResponseDTO,
    AssignRoutineRequestDTO, AssignRoutineResponseDTO,
    CompleteWorkoutRequestDTO, CompleteWorkoutResponseDTO
)
