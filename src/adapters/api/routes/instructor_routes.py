...
from src.adapters.api.dependencies_phase_f import get_list_instructors, get_assign_instructor, get_rate_instructor
from src.application.dtos.instructor_dtos import (
    ListInstructorsResponseDTO, AssignInstructorRequestDTO, AssignInstructorResponseDTO,
    RateInstructorRequestDTO, RateInstructorResponseDTO
)
