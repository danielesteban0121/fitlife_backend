...
from src.adapters.api.dependencies_phase_f import get_create_nutrition_plan, get_get_active_nutrition_plan
from src.application.dtos.nutrition_dtos import (
    CreateNutritionPlanRequestDTO, CreateNutritionPlanResponseDTO,
